"""This function asks the user for a sorted list of numbers and a number to be inserted in the list. It then returns a new sorted list with the number inserted in its appropriate position."""
