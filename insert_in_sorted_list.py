...
def insert_in_sorted_list():
    ...
    for index in range(list_length): # finds the position where the new element has to be inserted
    ...
    while count >= position: # creates space in the list for inserting the new element 
